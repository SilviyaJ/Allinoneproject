        ...
        <>
            {
                ...
                <>
                    <div className="container mt-5">
                        <h1 className="text-center text-danger">Welcome to Viyaworld</h1>
                        <div className="row justify-content-center">
                            <div className="col-lg-4 col-md-8 col-sm-12 shadow rounded-5 p-5"  style={{backgroundColor:'lightgreen'}}>
